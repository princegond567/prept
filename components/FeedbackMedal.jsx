...
const FeedbackMedal = ({ open, onOpenchange, feedback, intervieweeName}) => {
  ...
  return (
    <Dialog open={open} onOpenchange={onOpenchange}>
        <DialogContent className="bg-black border border-amber-200/20 text-stone-100 sm:max-w-2xl
        max-h-[85vh] overflow-y-auto">
            ...
            <div className='relative flex flex-col gap-5 mt-2'>
                {/* Rating */}
                <div
                    className={`rounded-2xl border ${rating.className} bg-linear-to-br 
                    ${rating.bg} to-transparent p-6 flex items-center justify-between`}
                >
                    <div>
