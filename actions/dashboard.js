...
const ADMIN_EMAIL = "princegond370@gmail.com";
...
export const requestWithdrawal = async ({
  ...
  const rateLimitError = await checkRateLimit({ aj: withdrawalLimiter, req, userId: user.id });
  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        from: "Prept <hello@mail.princeg.me>",
        to: ADMIN_EMAIL,
