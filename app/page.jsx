    ...
    <div className="bg-black overflow-x-hidden">
      ...
      <section className="pt-28 sm:pt-32 relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pb-20 overflow-hidden">
        ...
        items-center justify-center text-center lg:-rotate-2">
          ...
          <h1 className="font-serif relative text-5xl sm:w-6xl lg:text-7xl
      ...
      <section className="relative z-10 border-y border-white/10 py-14"> 
        <p className="text-center text-xs font-medium text-stone-600 tracking-widest uppercase mb-8">Interviewees landed roles at</p>
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 md:col-span-7">
              <BentoCard
                ...
                desc="Interviewers get a live AI co-pilot generating role-specific
                questions on demand - system design, behavioural, DSA - all tailored to
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {
            ROLES.map((role) => (
              <div
                ...
                hover:border-amber-400/20 rounded-2xl p-12 h-full transition
                duration-300 overflow-hidden"
              >
                <span className="inline-block text-xs font-semibold text-amber-400 
                tracking-widest uppercase border border-amber-400/20 bg-amber-400/10
                ...
                <ul className="space-y-3">
                  {
                    role.perks.map((p) => (
                      <li key={p} className="flex gap-3 text-sm text-stone-400">
                        <span className="mt-0.5 min-w-4 h-4 rounded-full bg-amber-400/10
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        <div className="relative border border-amber-400/20 rounded-3xl px-3 sm:px-16
        py-20 bg-linear-to-br from-amber-400/5 text-center overflow-hidden">
          <StarsBackgroundDemo />

          <h2 className="font-serif relative text-4xl md:text-5xl leading-tight
          tracking-tight mb-4">
