      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-stone-500 font-light mt-4 leading-relaxed">
            This help us personlise your experience
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {ONBOARDING_ROLES.map((r) => (
              <button
                ...
                className="text-left rounded-2xl p-8 border border-white/10 bg-[#0f0f11]
                             hover:border-amber-400/20 hover:-translate-y-0.5 transition-all duration-300"
              >
                <span
                  className="w-11 h-11 rounded-xl bg-amber-400/10 border
        ...
        {role && (
          <div className="flex flex-col gap-6">
            <div
              className="flex items-center justify-between bg-[#0f0f11] border 
                    border-white/10 rounded-2xl px-6 py-4"
            >
              <div className="flex items-center gap-3">
                <span
                  className="w-9 h-9 rounded-xl bg-amber-400/10 borderborder-amber-400/20 
            ...
            {role === "INTERVIEWER" && (
              <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
                ...
                <Textarea
                  rows={4}
                  maxLength={300}
                  placeholder="Tell interviewees about your background, what you sprecialise
                                in, and what they can expect from a session with you."
                  value={form.bio}
                  onChange={(e) =>
