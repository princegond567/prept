...
const SlotPicker = ({ interviewer, interviewerCredits, userCredits }) => {
  ...
  if (!availability) {
    return (
      <div
        className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 text-center
  ...
  return (
    <>
      <UpgradeModal
        ...
        reason={`You need ${interviewerCredits} credits to book this session. Your 
                current balance is ${userCredits}.`}
      />
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="text-right shrink-0">
              ...
              <p
                className="font-serif text-2xl leading-none bg-linear-to-br
            ...
            {dates.map((date) => {
              ...
              return (
                <button
                  ...
                  className={`shrink-0 flex flex-col items-center px-3.5 py-2.5 mb-1
              ...
              {slots.map((slot) => {
                ...
                return (
                  <button
                    ...
                    className={`relative text-xs px-2 py-2.5 rounded-xl border 
                                        transition-all duration-200 ${
                                          isSelected
                                            ...
                                            : slot.isBooked
                                              ...
                                              : "border-white/10 text-stone-400 hover:border-amber-400 hover:text-amber-400 hover:bg-amber-400/5 cursor-pointer"
                                        }`}
                  >
        ...
        {selectedSlot && (
          <div ref={summaryRef} className="bg-[#0f0f11] border border-amber-400/10 rounded-2xl p-6 flex flex-col gap-4">
            <p className="text-xs font-semibold text-stone-500 tracking-tight uppercase">
              Your booking
            </p>
            ...
            <div className="flex justify-between items-center">
              ...
              <span
                className="font-serif text-lg bg-linear-to-br from-amber-300 to-amber-500
